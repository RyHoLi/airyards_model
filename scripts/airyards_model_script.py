...
print(R_sq_gbm)
'''
R^2 = 0.28006836735871177
'''


# predict on most recent data
scaler = MinMaxScaler(feature_range=(0,1))
predict_data = pd.read_csv('C:/Users/Ryan/Documents/air_yards_model/data/airyards_predict_data_wk6.csv')
...
final_df.to_csv('C:/Users/Ryan/Documents/air_yards_model/data/airyards_predictions_wk6.csv', index=False)
final_df_results.to_csv('C:/Users/Ryan/Documents/air_yards_model/data/airyards_clean_predictions_wk6.csv', index=False)