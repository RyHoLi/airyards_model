...
model_data_df = pd.read_csv('C:/Users/Ryan/Documents/air_yards_model/data/airyards_data_test.csv')
...
df_predictors = model_data_df_train.iloc[:, np.r_[3:25]]
...
joblib.dump(cv.best_estimator_, f'{model_path}Airyards_RF_test.pkl')
model_rf = joblib.load(f'{model_path}Airyards_RF_test.pkl')
...
joblib.dump(cv.best_estimator_, f'{model_path}Airyards_GBM_test.pkl')
model_gbm = joblib.load(f'{model_path}Airyards_GBM_test.pkl')
...
predict_data2 = predict_data.iloc[:, np.r_[3:25]]
